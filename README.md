...
3. В открывшейся странице найдите блок с конфигурациями.
4. Скопируйте их вручную и вставьте в клиент (например, через «Импорт из буфера обмена» или создав новый конфиг вручную).
