...
Мы сознательно не тестируем конфиги в процессе сборки, потому что многие владельцы серверов специально ограничивают подключения не из РФ, а виртуальная машина от GitHub к сожалению находится тоже находятся не в РФ.
